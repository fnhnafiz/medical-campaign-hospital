...
import { FaArrowLeft } from "react-icons/fa"; // ✅ নতুন import
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900">
        ...
        {/* ✅ Back to Home button — শুধু এটা যোগ হয়েছে */}
        <Link
          to="/"
          className="flex items-center gap-2 text-sm text-gray-500 hover:text-emerald-600 transition-colors mb-4 w-fit"
        >
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-gray-400">Welcome to MED CAMP</p>
        </div>
        ...
        <form onSubmit={handleSubmit} noValidate="" action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
          ...
          <div>
            <button type="submit" className="bg-gradient-to-r from-emerald-500 to-teal-500 w-full rounded-md py-3 text-white">
        ...
        <p className="px-6 text-sm text-center text-gray-400">
          ...
          <Link to="/login" className="hover:underline hover:text-lime-500 text-gray-600">Login</Link>.
        </p>
      </div>
    </div>
  );
